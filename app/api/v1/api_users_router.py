...
@router.post("/accounts/sign_up_as_admin",tags=["Вход и регистрация"], description= "Зарегистрировать пользователя админом")
...
@router.post("/accounts/sign_up_as_hr",tags=["Вход и регистрация"], description="Зарегистрировать пользователя как работника отдела кадров (доступно без авторизации)")
...
@router.post("/accounts/sign_up",tags=["Вход и регистрация"], description="Зарегистрироваться")
...
@router.post("/auth/login",tags=["Вход и регистрация"], description="Войти")
...
@router.post("/auth/refresh",tags=["Вход и регистрация"], description="Обновить ключи доступа")
def refresh_token_route(refresh_token:str):
    return refresh_access_token(refresh_token)

@router.get("/users", response_model=Page[Users],tags=["Вход и регистрация"], description="Вывести всех пользователей (только для админа и HR!!)")
